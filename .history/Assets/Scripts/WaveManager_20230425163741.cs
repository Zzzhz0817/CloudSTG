...
public class WaveManager : MonoBehaviour
{
    ...
    private async void SpawnObstacle(Vector2 position1, Vector2 position2, int delayTime = 0)
    {
        ...
        spawnedObstacle.transform.localScale = new Vector3(spawnedObstacle.transform.localScale.x, spawnedObstacle.transform.localScale.y*(transform.position - new Vector3(world_pos.x, world_pos.y, 0f)).magnitude*0.3f, zhenEffect.transform.localScale.z);  
