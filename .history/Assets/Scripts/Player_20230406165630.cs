...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (zhenActiveFlag && Input.touchCount == 1)
        {
            ...
            zhenEffect.transform.localScale = new Vector3(zhenEffect.transform.localScale.x *(transform.position - new Vector3(world_pos.x, world_pos.y, 0f)).magnitude, zhenEffect.transform.localScale.y, zhenEffect.transform.localScale.z);
        }
    ...
    private void LoadFromPlayerPrefs()
    {
        ...
        defaultSaveData.guaList_save = new List<int>{0,5,0,0,5,0,0,0};
