...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpriteRenderer neckRenderer = NeckRenderer.GetComponent<SpriteRenderer>();
        SpriteRenderer headRenderer = HeadRenderer.GetComponent<SpriteRenderer>();
        neckRenderer.sprite = necks[MAX_QI/qi];
