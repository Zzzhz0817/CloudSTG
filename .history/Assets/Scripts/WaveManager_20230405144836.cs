...
public class WaveManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (waveTimer > waveInterval) 
        {
            ...
            {
                Spawn(enemyShooter, new Vector2(-1.5f, 5.5f));
                Spawn(enemyRusherRight, new Vector2(-1.2f, 6f), 500);
                Spawn(enemyShooter, new Vector2(1.5f, 5.5f));
            ...
            else if (waveNum % 5 == 4)
            {
                ...
                Spawn(enemyRusherRight, new Vector2(-1.2f, 6f), 500);
                Spawn(enemyRusherLeft, new Vector2(1.2f, 6f), 500);
            }
            else if (waveNum % 5 == 0)
            {
                Spawn(enemyFlyerRight, new Vector2(-0.85f, 6f), 0);
                Spawn(enemyFlyerRight, new Vector2(-0.85f, 6f), 200);
                ...
                Spawn(enemyFlyerLeft, new Vector2(0.85f, 6f), 200);
                Spawn(enemyFlyerLeft, new Vector2(0.85f, 6f), 400);
                Spawn(enemyFlyerLeft, new Vector2(0.85f, 6f), 600);
                Spawn(enemyFlyerLeft, new Vector2(0.85f, 6f), 800);
                Spawn(enemyFlyerLeft, new Vector2(0.85f, 6f), 1000);
            }
