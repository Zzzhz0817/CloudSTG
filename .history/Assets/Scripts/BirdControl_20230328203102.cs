...
public class BirdControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {   
            ...
            lookDirection = new Vector2(world_pos0[0]-world_pos1[0], world_pos0[1]-world_pos1[1]);
    ...
    private void Launch()
    {
        GameObject projectileObject = Instantiate(projectilePrefab, rigidbody2d.position+Vector2.up*0.8f, Quaternion.identity);
