...
public class Enemy : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < wayPointCollection.childCount; i++)
        {
            ...
            Debug.Log(wayPointCollection.childCount);
            Debug.Log(wayPointCollection.GetChild(i));
            Debug.Log(wayPointCollection.GetChild(i).transform);
            Debug.Log(wayPointCollection.GetChild(i).transform.position);
