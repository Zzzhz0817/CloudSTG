...
public class Player : MonoBehaviour
{
    ...
    public void GetYao(bool isYang)
    {
        ...
        if (guaDict["Dui"] > 0)
        {
            ...
            var healEffect = Instantiate(duiHealingEffect, new Vector3 (orientationVector.x, orientationVector.y, 0f)*0.36f + transform.position, Quaternion.identity);
    ...
    public void GetHit()
    {
        if (invincibleTimer > invincibleTime)
        {
            ...
            var hitEffect = Instantiate (getHitEffect, transform.position, Quaternion.identity);
    ...
    private void LoadFromPlayerPrefs()
    {
        ...
        defaultSaveData.guaList_save = new List<int>{0,0,0,1,0,0,0,0};
