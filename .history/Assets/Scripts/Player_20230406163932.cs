...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (zhenActiveFlag && Input.touchCount == 1)
        {
            ...
            zhenEffect.transform.localScale = new Vector3(zhenEffect.transform.localScale.x *(transform.position - new Vector3(world_pos.x, world_pos.y, 0f)).magnitude, xunWindEffect.transform.localScale.y, xunWindEffect.transform.localScale.z);
        }
